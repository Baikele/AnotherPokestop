...
public class OldPokeStopData extends Config {
    ...
    public OldPokeStopData() {

    }

    public OldPokeStopData(UUID pokeStopUniqueId, RGBStorage color, World world, double posX, double posY, double posZ, LoottableStorage loottable) {
