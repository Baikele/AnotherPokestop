...
import eu.pixelunited.anotherpokestop.config.loottables.LootTableData;
...
public class RewardUtils {
    ...
    public static void pokestopLoot(EntityPlayerMP player, boolean rocket, String lootTable) {
        ...
        if(!rocket) {
            ...
            lootConfigAmount = _lootConfig.loottable.lootSize * AnotherPokeStop.getRegistry().lootMultiplier;
        } else {
            _loot = Objects.requireNonNull(getLoottable(lootTable)).loottable.rocketData;
            lootConfigAmount = _lootConfig.loottable.rocketLootSize * AnotherPokeStop.getRegistry().lootMultiplier;
        }
